...
bool Basement::init()
{
	...
	addBoxBodyForStaticNonWall(key, keyB);
...
void Basement::update(float delta) {
	...
	display->setPosition(sprite->getPositionX() - 300, sprite->getPositionY() + 300);      // sets position of the inventory image
	display2->setPosition(sprite->getPositionX() - 300, sprite->getPositionY() + 300);
	display3->setPosition(sprite->getPositionX() - 300, sprite->getPositionY() + 300);
	display4->setPosition(sprite->getPositionX() - 300, sprite->getPositionY() + 300);
	display5->setPosition(sprite->getPositionX() - 300, sprite->getPositionY() + 300);
	display6->setPosition(sprite->getPositionX() - 300, sprite->getPositionY() + 300);
